...
public String toString() {
	if (Animal.zona==null) {
		...
		return("Mi nombre es "+ nombre + ", tengo una edad de "+ edad + ", habito en " + habitat + "y mi genero es " + genero + ", la zona en la que me ubico es " + Zona.getZona() + ", en el " + Zoo.getNombre());
	}
}
